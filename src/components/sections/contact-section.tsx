...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="mx-auto max-w-screen-lg px-4 py-6 text-center"
    >
        ...
        <div className="md:flex-[2]">
          ...
          <Form {...form}>
            ...
            >
              ...
              />
              <Button type="submit" size="lg" className="self-start border dark:border-dark-neutral dark:bg-zinc-900 rounded-xl">
                Submit
              </Button>
            </form>
          </Form>
